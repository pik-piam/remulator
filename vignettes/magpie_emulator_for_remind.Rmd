...
The header doesn't make a difference in this case. If you want to force REMIND to use your new emulators, all you have to do is replace all scenarios and rcps in this file with fits from your new emulator. First make copy of the original to be sure.
...
# Replaces repeating data on all dimensions
out[,,] <- new
...
If you check `/path/to/remind/modules/30_biomass/magpie_40/input/f30_bioen_price.cs4r`, the values for all scenarios and rcps should be the same (different between regions, years and coefficients).
